-- ================================================
-- Update submit_mock_test_with_answers to store max_score
-- ================================================
...
BEGIN
  ...
  LOOP
    ...
    FROM mock_test_question_options o
  ...
  -- Calculate percentage correctly (total_score / max_possible_score * 100)
  v_percentage := CASE
  ...
  -- Update attempt with final scores including max_score
  UPDATE mock_test_attempts
  SET
    total_score = v_total_score,
    max_score = v_max_possible_score,  -- ✅ NOW STORING max_score
  ...
  -- Return results including max_score
  RETURN json_build_object(
    'total_score', v_total_score,
    'max_score', v_max_possible_score,  -- ✅ NOW RETURNING max_score
