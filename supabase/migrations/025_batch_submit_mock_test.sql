-- Batch submit mock test with all answers in one transaction
-- This replaces the individual answer save approach with atomic batch processing
-- Accepts all answers as JSONB: { "question_id": "option_id", ... }
