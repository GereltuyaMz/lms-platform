...
const goals = [
  {
    value: "Өөрийгөө хөгжүүлэх",
    label: "Өөрийгөө хөгжүүлэх",
    icon: "🌳",
  },
  {
    value: "Сурлагаа дээшлүүлэх",
    label: "Сурлагаа дээшлүүлэх",
    icon: "📚",
  },
  {
    value: "Шинэ сэдвүүд судлах",
    label: "Шинэ сэдвүүд судлах",
    icon: "🔔",
  },
  {
    value: "Амжилтаа бататгах",
    label: "Амжилтаа бататгах",
    icon: "🎉",
  },
];

export const Step2Goal = ({ selectedGoal, onSelectGoal }: Step2GoalProps) => {
  return (
